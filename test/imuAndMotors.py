...
MAX_DC     = 40    # duty cycle bij grote fout     (was 75)
MIN_DC     = 8     # minimale duty cycle bij naderen (was 20)
AFREM_ZONE = 15.0  # graden — binnen deze zone wordt afgerempt
...
try:
    while True:
        ...
        frame = np.zeros((280, 500, 3), dtype=np.uint8)
        ...
        tekst(frame, f"PWM: {PWM_FREQ}Hz | Max DC: {MAX_DC}% | Min DC: {MIN_DC}%", 210, (100, 100, 255))
        tekst(frame, "ESC = afsluiten | Terminal = doelhoek / 'hoek'", 245, (180, 180, 180))
